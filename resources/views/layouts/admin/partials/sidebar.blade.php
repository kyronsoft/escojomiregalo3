            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    @if (auth()->user()->hasRole('Admin'))
                        ...
                        {{-- Dashboard --}}
                        <li class="dropdown">
                            <a class="nav-link menu-title {{ prefixActive('dashboard.index') }}"
                            ...
                            <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('dashboard.index') }};">
                                <li>
                                    <a href="{{ route('dashboard.index') }}"
                                        class="{{ routeActive('dashboard.index') }}">
                                        Ecommerce
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/empresas') }};">
                                ...
                                <li>
                                    <a href="{{ route('empresas.index') }}"
                                        class="{{ routeActive('empresas.index') }}">
                                        Listar Empresas
                                    </a>
                                </li>
                            </ul>
                        ...
                        {{-- ================= RRHH-Cliente: Dashboard + Avance Campaña ================= --}}
                    @elseif(auth()->user()->hasRole('RRHH-Cliente'))
                        <li class="sidebar-main-title">
                            <div>
                                <h6>General</h6>
                            </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="nav-submenu menu-content"
                                style="display: {{ prefixBlock('dashboard.index') }};">
                                <li>
                                    <a href="{{ route('dashboard.index') }}"
                                        class="{{ routeActive('dashboard.index') }}">
                                        Ecommerce
                        ...
                        {{-- Utilidades → Avance Campaña --}}
                        <li class="dropdown">
                            <a class="nav-link menu-title {{ prefixActive('seleccionados.index') }}"
                                href="javascript:void(0)">
                                <i data-feather="layout"></i><span>Utilidades</span>
                            </a>
                            <ul class="nav-submenu menu-content"
                        ...
                        {{-- ===== Ejecutiva-Empresas: SOLO "Listar", + Dashboard, + Avance Campaña ===== --}}
                    @elseif(auth()->user()->hasRole('Ejecutiva-Empresas'))
                        <li class="sidebar-main-title">
                            <div>
                                <h6>General</h6>
                            </div>
                        ...
                        {{-- Campañas (solo Listar) --}}
                        <li class="dropdown">
                            <a class="nav-link menu-title {{ prefixActive('/campaigns') }}"
                                href="javascript:void(0)">
                                <i data-feather="layout"></i><span>Campañas</span>
                            </a>
                            <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/campaigns') }};">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="nav-submenu menu-content"
                                style="display: {{ prefixBlock('/colaboradores') }};">
                                <li>
                                    <a href="{{ route('colaboradores.index') }}"
                                        class="{{ routeActive('colaboradores.index') }}">
                                        Listar Colaboradores
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="nav-submenu menu-content"
                                style="display: {{ prefixBlock('/campaign_toys') }};">
                                <li>
                                    <a href="{{ route('campaign_toys.index') }}"
                                        class="{{ routeActive('campaign_toys.index') }}">
                                        Listar Referencias
                        ...
                        {{-- Utilidades (solo Avance Campaña) --}}
                        <li class="dropdown">
                            <a class="nav-link menu-title {{ prefixActive('seleccionados.index') }}"
                                href="javascript:void(0)">
                                <i data-feather="layout"></i><span>Utilidades</span>
                    ...
                    @else
                        ...
                        {{-- Usuarios --}}
                        <li class="dropdown">
                            <a class="nav-link menu-title {{ prefixActive('users.index') }}"
                                href="javascript:void(0)">
                                <i data-feather="layout"></i><span>Usuarios</span>
                            </a>
                            <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('users.index') }};">
