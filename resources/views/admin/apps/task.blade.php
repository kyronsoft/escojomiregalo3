                                ...
                                <div class="card-body">
                                    <div class="email-app-sidebar left-bookmark">
                                        ...
                                        <ul class="nav main-menu" role="tablist">
                                                                        ...
                                                                        <div class="form-group col-md-12">
                                                                            <div class="d-flex date-details">
                                                                                <div class="d-inline-block">
                                                                                    <label class="d-block mb-0"> <input
                                            ...
                                            <li>
                                                <a class="show" id="pills-notification-tab" data-bs-toggle="pill"
                                            ...
                                            <li>
                                                <a class="show" id="pills-newsletter-tab" data-bs-toggle="pill"
                                                    href="#pills-newsletter" role="tab"
                                                    aria-controls="pills-newsletter" aria-selected="false">
