                                    ...
                                    <table style="width: 650px; margin: 0 auto; margin-bottom: 30px;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: right; color: #999;"><span>Some
                                                        Description</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px;">
                                    ...
                                    <p>you forgot your password for viho Admin. If this is true, click below to reset
                                        your password.</p>
                                    <p style="text-align: center;">
                                        <a href="javascript:void(0)"
                                            style="padding: 10px; background-color: #72CB00; color: #fff; display: inline-block; border-radius: 4px; font-weight: 600;">Reset
                                            Password</a>
                                    </p>
                            ...
                            <tr style="text-align: center;">
                                <td>
                                    ...
                                    <p style="color: #999; margin-bottom: 0;">Don't Like These Emails?<a
                                            href="javascript:void(0)" style="color: #72CB00;">Unsubscribe</a></p>
