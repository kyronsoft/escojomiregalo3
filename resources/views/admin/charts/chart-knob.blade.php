        ...
        <div class="row">
                            ...
                            <div class="chart-clock-main">
                                <div class="clock-large">
                                    <input class="knob hour" data-min="0" data-max="24" data-bgcolor="#eeeeee"
                                        data-fgcolor="#72CB00" data-displayinput="false" data-width="300" data-height="300"
                                        data-thickness=".2" />
                                </div>
                                <div class="clock-medium">
                                    <input class="knob minute" data-min="0" data-max="60" data-bgcolor="#eeeeee"
                                        data-fgcolor="#ba895d" data-displayinput="false" data-width="200" data-height="200"
                                        data-thickness=".20" />
                                </div>
                                <div class="clock-small">
                                    <input class="knob second" data-min="0" data-max="60" data-bgcolor="#eeeeee"
                                        data-fgcolor="#222222" data-displayinput="false" data-width="100" data-height="100"
                                        data-thickness=".2" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="knob-block text-center">
                            <input class="knob" data-width="295" data-height="295" data-angleoffset="180"
                                data-fgcolor="#72CB00" data-skin="tron" data-thickness=".1" value="35" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="knob-block text-center">
                            <input class="knob" data-width="200" data-thickness=".1" data-angleoffset="90"
                                data-fgcolor="#72CB00" data-linecap="round" value="35" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 xl-50 col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="knob-block text-center">
                            <input class="knob" data-width="200" data-thickness=".1" data-fgcolor="#72CB00"
            ...
            <div class="col-xl-4 xl-50 col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="knob-block text-center">
                            <input class="knob" data-width="200" data-cursor="true" data-fgcolor="#72CB00"
            ...
            <div class="col-xl-4 xl-50 col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="knob-block text-center">
                            <input class="knob" data-angleoffset="-125" data-anglearc="250" data-fgcolor="#72CB00"
            ...
            <div class="col-xl-4 xl-50 col-sm-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="knob-block text-center">
                            <input class="knob" data-min="-10000" data-thickness=".1" data-fgcolor="#72CB00"
