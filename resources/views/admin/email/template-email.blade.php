            ...
            <tr>
                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('assets/images/email-template/1.jpg') }}" alt=""
                                        style="width: 100%;" /></td>
                            </tr>
                        </tbody>
                    </table>
                    <h4 class="title" style="text-align: center;">Additional 50% Off</h4>
                    <h5 style="text-align: center;color: #aba8a8;font-size: 14px;}">On clothes for kids,women & Mens
                        Wear</h5>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img class="img-fluid"
                                                src="{{ asset('assets/images/email-template/7.png') }}"
                                                alt="product" /></div>
                                        <div class="product-info">
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img class="img-fluid"
                                                src="{{ asset('assets/images/email-template/8.png') }}"
                                                alt="product" /></div>
                                        <div class="product-info">
