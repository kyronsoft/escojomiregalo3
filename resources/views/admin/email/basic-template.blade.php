                            ...
                            <tr>
                                <td>
                                    <table style="width: 650px; margin: 0 auto; margin-bottom: 30px;">
                                        <tbody>
                                            <tr>
                                                <td><img src="{{ asset('assets/images/logo/logo.png') }}"
                                                        alt="" /></td>
                                            ...
                                            <tr>
                                                <td style="padding: 30px;">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        style="padding: 10px; background-color: #72CB00; color: #ffffff; display: inline-block; border-radius: 4px; margin-bottom: 18px;">Call
                                                        To Action </a>
                                            ...
                                            <tr style="text-align: center;">
                                                <td>
                                                    ...
                                                    <p style="color: #999; margin-bottom: 0;">Don't Like These Emails?<a
                                                            ...
                                                            style="color: #72CB00;">Unsubscribe</a></p>
