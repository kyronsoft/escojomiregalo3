    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"
        ...
        <tr>
            <td align="center" style="padding:20px 10px;">
                ...
                <!-- Container 650px (contenido principal) -->
                <table role="presentation" align="center" cellpadding="0" cellspacing="0" border="0" width="650"
                    style="width:650px;max-width:650px;background-color:#ffffff;padding:30px;box-shadow:0 0 14px -4px rgba(0,0,0,0.27);-webkit-box-shadow:0 0 14px -4px rgba(0,0,0,0.27);">
                    <tr>
                        <td style="padding:0;">
                            ...
                            <table role="presentation" align="left" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td align="center" style="padding:0 0 10px 0;">
                                        <!-- SVG principal (idéntico) -->
                                        <svg style="width:170px;display:block;" enable-background="new 0 0 512 512"
                                ...
                                <tr>
                                    <td style="padding:0;">
                                        ...
                                        <p
                                            style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:21px;color:#aba8a8;margin:0;">
                                            Transaction ID : 267676GHERT105467,</p>
                                    </td>
                                </tr>
                            </table>

                            <!-- Dos columnas: Shipping / Billing -->
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="left"
                                width="100%" style="width:100%;margin-top:10px;margin-bottom:10px;">
                                <tr>
                                    <td valign="top"
                                        style="background-color:#fafafa;padding:15px;letter-spacing:0.3px;width:50%;">
                                        <h5
                                            style="font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:600;color:#000;line-height:16px;padding-bottom:13px;border-bottom:1px solid #e6e8eb;letter-spacing:-0.65px;margin:0 0 13px 0;">
                                            Your Shipping Address</h5>
                                        <p
                                            style="text-align:left;font-weight:normal;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#aba8a8;line-height:21px;margin:0;">
                                            268 Cambridge Lane New Albany,<br>IN 47150268 Cambridge Lane <br>New Albany,
                                            IN 47150
                                        </p>
                                    </td>
                                    <td style="width:30px;" align="center">
                                        <img src="{{ asset('assets/images/email-template/space.jpg') }}"
                                            alt="" height="25" width="30"
                            ...
                            <!-- Tabla de orden (con bordes inline, sin nth-child) -->
                            <table role="presentation" class="order-detail" cellpadding="0" cellspacing="0"
                                border="0" align="left" width="100%"
                                style="width:100%;margin-bottom:50px;border:1px solid #ddd;border-collapse:collapse;">
                                <tr>
                                    <th align="center"
                                        style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#444;padding:15px;border:1px solid #ddd;background:#fafafa;">
                                        PRODUCT</th>
                                    <th align="left"
                                        style="font-family:Arial,Helvetica,sans-serif;font-size:16px;color:#444;padding:15px;border:1px solid #ddd;background:#fafafa;">
                                        DESCRIPTION</th>
                                ...
                                <!-- Fila 1 -->
                                <tr>
                                    <td style="border:1px solid #ddd;padding:12px;" align="center">
                                        <img src="{{ asset('assets/images/email-template/4.png') }}" alt=""
                                            width="80" style="display:block;border:0;">
                                    </td>
                                    <td valign="top" style="border:1px solid #ddd;padding:12px 12px 12px 15px;">
                                        <h5
                                            style="margin:15px 0 0 0;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#444;font-weight:400;">
                                            Three seater Wood Style sofa for Leavingroom</h5>
                                    </td>
                                    <td valign="top" style="border:1px solid #ddd;padding:12px 12px 12px 15px;">
                                        <h5
                                            style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#444;margin:15px 0 0 0;font-weight:400;">
                                            Size : <span>L</span></h5>
                                        <h5
                                            style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#444;margin:10px 0 0 0;font-weight:400;">
                                            QTY : <span>1</span></h5>
                                    </td>
                                    <td valign="top" style="border:1px solid #ddd;padding:12px 12px 12px 15px;">
                                        <h5
                                ...
                                <tr>
                                    <td style="border:1px solid #ddd;padding:12px;" align="center">
                                        <img src="{{ asset('assets/images/email-template/1.png') }}" alt=""
                                            width="80" style="display:block;border:0;">
                                    </td>
                                    <td valign="top" style="border:1px solid #ddd;padding:12px 12px 12px 15px;">
                                        <h5
                                ...
                                <!-- Totales (sin clases, con padding/bordes) -->
                                <tr>
                                    <td colspan="2" align="left"
                                        style="border:1px solid #ddd;padding:5px 15px;">
                                        <p
                                            style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#000;">
                                            Subtotal :</p>
                                    </td>
                                    <td colspan="2" align="right"
                                        style="border:1px solid #ddd;padding:5px 15px;">
                                        <b style="font-family:Arial,Helvetica,sans-serif;font-size:15px;">$2000</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"
                                    ...
                                    <td colspan="2" align="right"
                                        style="border:1px solid #ddd;padding:5px 15px;">
                                        <b style="font-family:Arial,Helvetica,sans-serif;font-size:15px;">$5</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" align="right"
                                        style="border:1px solid #ddd;padding:5px 15px;">
                                        <b style="font-family:Arial,Helvetica,sans-serif;font-size:15px;">$2</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"
                                    ...
                                    <td colspan="2" align="right"
                                        style="border:1px solid #ddd;padding:5px 15px;">
                                        <b style="font-family:Arial,Helvetica,sans-serif;font-size:15px;">$1000</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="left"
                                    ...
                                    <td colspan="2" align="right"
                                        style="border:1px solid #ddd;padding:5px 15px;">
                                        <b style="font-family:Arial,Helvetica,sans-serif;font-size:15px;">$2600</b>
                                    </td>
                                </tr>
                            </table>

                            <!-- Footer: Follow us -->
                            <table role="presentation" class="main-bg-light text-center top-0" align="center"
                                ...
                                <tr>
                                    <td style="padding:30px;" align="center">
                                        <div>
                                            <h4 class="title"
                                                style="margin:0;text-align:center;color:#444444;font-size:22px;font-weight:bold;padding-bottom:0;text-transform:uppercase;display:inline-block;line-height:1;font-family:Arial,Helvetica,sans-serif;">
                                                Follow us</h4>
                                        </div>

                                        <!-- Íconos sociales (reemplazo de FontAwesome) -->
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                                            align="center" style="margin-top:20px;">
                                            <tr>
                                                <td>
                                                    <a href="https://facebook.com" style="text-decoration:none;">
                                                        <img src="https://TU-DOMINIO.com/icons/facebook.png"
                                                ...
                                                <td>
                                                    <a href="https://youtube.com" style="text-decoration:none;">
                                                        <img src="https://TU-DOMINIO.com/icons/youtube.png"
                                                ...
                                                <td>
                                                    <a href="https://twitter.com" style="text-decoration:none;">
                                                        <img src="https://TU-DOMINIO.com/icons/twitter.png"
                                                ...
                                                <td>
                                                    <a href="https://plus.google.com" style="text-decoration:none;">
                                                        <img src="https://TU-DOMINIO.com/icons/googleplus.png"
                                                            alt="Google Plus" width="40" height="40"
                                                            style="display:block;border:0;">
                                                    </a>
                                                </td>
                                                <td width="15">&nbsp;</td>
                                                <td>
                                                    <a href="https://linkedin.com" style="text-decoration:none;">
                                                        <img src="https://TU-DOMINIO.com/icons/linkedin.png"
                                        ...
                                        <div style="border-top:1px solid #ddd;margin:20px auto 0;width:100%;"></div>

                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                                            width="100%" style="margin:20px auto 0;">
                                            <tr>
                                                <td align="center">
                                                    <a href="https://TU-DOMINIO.com/preferences"
                                                        style="color:#72CB00;font-size:14px;text-transform:capitalize;font-weight:600;font-family:Arial,Helvetica,sans-serif;text-decoration:none;">Want
                                                        to change how you receive these emails?</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <p
                                                        style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px;margin:8px 0;color:#aba8a8;">
                                                        2021 - 22 Copy Right by Themeforest powerd by Pixel Strap</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <a href="https://TU-DOMINIO.com/unsubscribe"
                                                        style="color:#72CB00;font-size:14px;text-transform:capitalize;font-weight:600;margin:0;text-decoration:underline;font-family:Arial,Helvetica,sans-serif;">Unsubscribe</a>
                                                </td>
                                            </tr>
                                        </table>
