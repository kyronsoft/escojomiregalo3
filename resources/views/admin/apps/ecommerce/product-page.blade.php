                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pro-group pt-0 border-0">
                                ...
                                <a class="btn btn-secondary mt-0" href="cart"><i class="fa fa-shopping-cart me-2"></i>Buy
                                    Now</a>
                            </div>
                            <div class="pro-group">
                            ...
                            <div class="pro-group pb-0">
                                <div class="pro-shop">
                                    <a class="btn btn-primary m-r-10" href="cart"> <i
                                            class="fa fa-shopping-basket me-2"></i>Add To Cart</a>
                                    <a class="btn btn-danger" href="list-wish"><i class="fa fa-heart me-2"></i>Add To
                                        WishList </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <ul class="nav nav-tabs border-tab mb-0" id="top-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="top-home-tab" data-bs-toggle="tab" href="#top-home"
                                role="tab" aria-controls="top-home" aria-selected="false">Febric</a>
                            <div class="material-border"></div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-top-tab" data-bs-toggle="tab" href="#top-profile"
                                role="tab" aria-controls="top-profile" aria-selected="false">Video</a>
                            <div class="material-border"></div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="contact-top-tab" data-bs-toggle="tab" href="#top-contact"
                                role="tab" aria-controls="top-contact" aria-selected="true">Details</a>
                            <div class="material-border"></div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="brand-top-tab" data-bs-toggle="tab" href="#top-brand"
