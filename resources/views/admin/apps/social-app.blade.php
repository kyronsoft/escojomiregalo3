                    ...
                    <div class="card">
                        <div class="social-tab">
                            <ul class="nav nav-tabs" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-timeline" data-bs-toggle="tab" href="#timeline"
                                        role="tab" aria-controls="timeline" aria-selected="true"><i
                                            data-feather="clock"></i>Timline</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="top-about" data-bs-toggle="tab" href="#about" role="tab"
                                        aria-controls="about" aria-selected="false"><i data-feather="alert-circle"></i>About
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="top-friends" data-bs-toggle="tab" href="#friends" role="tab"
                                        aria-controls="friends" aria-selected="false"><i
                                            data-feather="users"></i>Friends</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="top-photos" data-bs-toggle="tab" href="#photos" role="tab"
                                        aria-controls="photos" aria-selected="false"><i data-feather="image"></i>Photos</a>
                                </li>
                            </ul>
                                            ...
                                            <div class="collapse show" id="collapseicon" aria-labelledby="collapseicon"
                                                ...
                                                <div class="card-body socialprofile filter-cards-view">
                                                                ...
                                                                <span>
                                                                    <i class="fa fa-comments-o"> </i><span
                                                                        class="px-2">Messages<span
                                                                            class="badge badge-pill badge-light ms-1">9</span></span>
                                                                </span>
                                                            </span>
                                                            <span class="d-block">
                                                                <span>
                                                    ...
                                                    <div class="social-btngroup d-flex">
                                                        ...
                                                        <button class="btn btn-primary-light text-center"
                                            ...
                                            <div class="collapse show" id="collapseicon1" data-parent="#accordion"
                                                ...
                                                <div class="card-body social-status filter-cards-view">
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <a href=#><span class="f-w-600 d-block">Bucky
                                                                    Barnes</span></a><span
                                                                class="d-block">winter@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="media-body">
                                                            <a href=#><span class="f-w-600 d-block">Sarah
                                                                    Loren</span></a><span
                                                                class="d-block">barnes@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="media-body">
                                                            <a href=#><span class="f-w-600 d-block">Jason
                                                                    Borne</span></a><span
                                                                class="d-block">jasonb@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="social-status social-offline"></div>
                                                        <div class="media-body">
                                                            <a href=#><span class="f-w-600 d-block">Comeren
                                                                    Diaz</span></a><span
                                                                class="d-block">comere@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="social-status social-online"></div>
                                                        <div class="media-body">
                                                            <a href=#><span class="f-w-600 d-block">Andew
                                                                    Jon</span></a><span
                                                                class="d-block">andrewj@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="media-body"><span class="f-w-600 d-block">Johny
                                                                Waston</span><span class="d-block">johny@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="social-status social-offline"></div>
                                                        <div class="media-body">
                                                            <a href=#><span class="f-w-600 d-block">Johny
                                                                    William</span></a><span
                                                                class="d-block">johnyw@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <a href=#><span class="f-w-600 d-block">Johny
                                                                    Waston</span></a><span
                                                                class="d-block">johny@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p>Commented on Shaun Park's <a
                                                                    href="javascript:void(0)">Photo</a></p>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="timeline-content">
                                                <p>
                                                    ...
                                                    urna in justo euismod condimentum. Fusce placerat enim et odio molestie
                                                    sagittis.
                                                </p>
                                                ...
                                                <div class="social-chat">
                                                            ...
                                                            <div class="media-body">
                                                                <span class="f-w-600">
                                                                    Jason Borne <span>1 Year Ago <i
                                                                            class="fa fa-reply font-primary"></i></span>
                                                                </span>
                                                    ...
                                                    <div class="text-center"><a class="f-w-600"
                                                            href="javascript:void(0)">More Commnets</a></div>
                                                </div>
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <span class="d-block">
                                                                <span>
                                                                    <i class="fa fa-comments-o"> </i><span
                                                                        class="px-2">Messages<span
                                                                            class="badge badge-pill badge-light">9</span></span>
                                                                </span>
                                                            </span>
                                                            <span class="d-block">
                                                                <span>
                                                ...
                                                <div class="card-body social-status filter-cards-view">
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body"><span class="f-w-600 d-block">Bucky
                                                                Barnes</span><span class="d-block">winter@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="media-body"><span class="f-w-600 d-block">Sarah
                                                                Loren</span><span class="d-block">barnes@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                        ...
                                                        <div class="media-body"><span class="f-w-600 d-block">Jason
                                                                Borne</span><span class="d-block">jasonb@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="social-status social-offline"></div>
                                                        <div class="media-body"><span class="f-w-600 d-block">Johny
                                                                William</span><span class="d-block">johnyw@gmail.com</span>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <img class="img-50 rounded-circle m-r-15"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header">
                                            <h5 class="f-w-600">
                                                Hobbies and Interests<span class="pull-right"><i
                                                        data-feather="more-vertical"></i></span>
                                            </h5>
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header social-header">
                                            <h5>
                                                <span class="f-w-600">Education and Employement</span><span
                                                    class="pull-right"><i data-feather="more-vertical"></i></span>
                                            </h5>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="row details-about">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="activity-log">
                                                <div class="my-activity">
                                                    ...
                                                    <p>
                                                        <span><i class="m-r-20"
                                                                data-feather="thumbs-up"></i></span>Johny Waston likes
                                                        your post's.
                                                    </p>
                                                    <p>
                                                        <span><i class="m-r-20"
                                                                data-feather="user-plus"></i></span>Andew Jon became
                                                        friends with Comeren Diaz.
                                                    </p>
                                                    <p>
                                                        <span><i class="m-r-20"
                                                                data-feather="user-plus"></i></span>Johny Waston became
                                                        friends with Bucky Barnes.
                                                    </p>
                                                </div>
                                                <div class="my-activity">
